...
const BZT_CAREERS = [
  {
    id: "pentester",
    icon: "⚔️",
    title: { tr: "Etik Hacker & Sızma Testi Uzmanı", en: "Ethical Hacker & Penetration Tester" },
  ...
  },
  {
    id: "soc-analyst",
    icon: "🛡️",
    title: { tr: "SOC Analisti & Tehdit Avcısı", en: "SOC Analyst & Threat Hunter" },
    ...
    recommendedLessons: ["net-foundations", "active-recon-nmap", "blue-team-career"],
    overview: {
  ...
  },
  {
    id: "db-sec-expert",
    icon: "🗄️",
    title: { tr: "Veritabanı Güvenliği & SQL Uzmanı", en: "Database Security & SQL Specialist" },
    ...
    recommendedLessons: ["sqli-exploitation", "cryptography-hashing"],
    overview: {
  ...
  },
  {
    id: "cloud-sec-expert",
    icon: "☁️",
    title: { tr: "Bulut Güvenliği Uzmanı (Cloud Security)", en: "Cloud Security Specialist (AWS/Azure/GCP)" },
    ...
    recommendedLessons: ["rce-ssrf-deserialization", "net-foundations"],
    overview: {
  ...
  },
  {
    id: "malware-analyst",
    icon: "🔬",
    title: { tr: "Zararlı Yazılım Analisti & Tersine Mühendis", en: "Malware Analyst & Reverse Engineer" },
    ...
    recommendedLessons: ["red-team-evasion", "cryptography-hashing"],
    overview: {
  ...
  },
  {
    id: "dfir-expert",
    icon: "🔍",
    title: { tr: "Adli Bilişim & Olay Müdahale (DFIR)", en: "Digital Forensics & Incident Response (DFIR)" },
    ...
    recommendedLessons: ["linux-bash-mastery", "active-directory-attacks", "blue-team-career"],
    overview: {
  ...
  },
  {
    id: "appsec-devsecops",
    icon: "🚀",
    title: { tr: "Uygulama Güvenliği & DevSecOps", en: "Application Security & DevSecOps Engineer" },
    ...
    recommendedLessons: ["sqli-exploitation", "xss-csrf-dom", "rce-ssrf-deserialization", "burpsuite-masterclass"],
    overview: {
  ...
  },
  {
    id: "crypto-architect",
    icon: "🔐",
    title: { tr: "Kriptografi & Güvenlik Mimarisi", en: "Cryptography & Security Architect" },
    ...
    recommendedLessons: ["cryptography-hashing", "net-foundations"],
    overview: {
  ...
  },
  {
    id: "osint-soceng",
    icon: "🕵️",
    title: { tr: "Sosyal Mühendislik & OSINT İstihbaratçısı", en: "OSINT & Social Engineering Specialist" },
    ...
    recommendedLessons: ["osint-recon-deep", "wireless-social-eng"],
    overview: {
  ...
  },
  {
    id: "iot-scada-expert",
    icon: "⚡",
    title: { tr: "IoT, Donanım & Endüstriyel Siber Güvenlik (OT/SCADA)", en: "IoT, Hardware & Industrial Cyber Security (OT/SCADA)" },
    ...
    recommendedLessons: ["net-foundations", "active-recon-nmap", "wireless-social-eng"],
    overview: {
      ...
      return `
        <div class="glass-panel p-4 rounded-xl border transition-all duration-200 cursor-pointer ${isSelected ? 'border-cyan-500 bg-cyan-950/30 shadow-lg shadow-cyan-950/40' : 'border-gray-800 hover:border-gray-700'}" onclick="BZTCareers.selectCareer('${c.id}')">
          <div class="flex items-start justify-between gap-3 mb-2">
            ...
            <button class="text-xs px-2 py-1 rounded font-mono font-bold transition-all ${isSelected ? 'bg-cyan-500 text-black' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'}">
  ...
  selectCareer(id) {
    ...
    if (indicator) {
      if (career) {
        ...
        indicator.innerHTML = `
          <span>🎯 ${lang === 'tr' ? 'Aktif Kariyer:' : 'Active Career:'} <b class="text-cyan-400">${career.title[lang] || career.title.tr}</b></span>
          <button onclick="BZTCareers.clearFilter()" class="ml-2 text-gray-400 hover:text-white text-xs">✕ ${lang === 'tr' ? 'Temizle' : 'Clear'}</button>
        `;
      } else {
